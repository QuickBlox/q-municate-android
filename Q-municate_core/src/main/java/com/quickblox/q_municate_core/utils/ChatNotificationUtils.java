...
public class ChatNotificationUtils {
    ...
    public static final String PROPERTY_NOTIFICATION_TYPE_CHAT_ADDED_FRIENDS = "9";
    public static final String PROPERTY_NOTIFICATION_TYPE_CHAT_NAME = "10";
    public static final String PROPERTY_NOTIFICATION_TYPE_CHAT_PHOTO = "11";
    public static final String PROPERTY_NOTIFICATION_TYPE_CHAT_LEAVE = "12";
    public static final String PROPERTY_NOTIFICATION_TYPE_CHAT_CREATE_2 = "8";
    ...
    public static QBDialog parseDialogFromQBMessage(Context context, QBMessage chatMessage,
            String lastMessage, long dateSent, QBDialogType dialogType) {
    ...
    public static int getNotificationTypeIfExsist(QBChatMessage chatMessage) {
        int friendsMessageTypeCode = 0;
    ...
    public static boolean isFriendsMessageTypeCode(int friendsMessageTypeCode) {
        return PROPERTY_TYPE_TO_PRIVATE_CHAT__FRIENDS_ACCEPT
    ...
    public static boolean isNotificationMessageUpdateDialog(int messagesNotificationTypeCode) {
        return PROPERTY_NOTIFICATION_TYPE_CHAT_CREATE_2.equals(
                messagesNotificationTypeCode + ConstsCore.EMPTY_STRING) || PROPERTY_NOTIFICATION_TYPE_CHAT_ADDED_FRIENDS
                .equals(messagesNotificationTypeCode + ConstsCore.EMPTY_STRING) || PROPERTY_NOTIFICATION_TYPE_CHAT_NAME
                .equals(messagesNotificationTypeCode + ConstsCore.EMPTY_STRING) || PROPERTY_NOTIFICATION_TYPE_CHAT_PHOTO
                .equals(messagesNotificationTypeCode + ConstsCore.EMPTY_STRING) || PROPERTY_NOTIFICATION_TYPE_CHAT_LEAVE
