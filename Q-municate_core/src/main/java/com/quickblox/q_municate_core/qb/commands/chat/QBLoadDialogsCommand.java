...
public class QBLoadDialogsCommand extends ServiceCommand {
    ...
    public Bundle perform(Bundle extras) throws Exception {
        final ArrayList<ParcelableQBDialog > parcelableQBChatDialog  = new ArrayList<>();
        ...
        parcelableQBChatDialog .addAll(ChatUtils.qBDialogsToParcelableQBDialogs(
                loadAllDialogs(returnedBundle, qbRequestGetBuilder)));

        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(QBServiceConsts.EXTRA_CHATS_DIALOGS, parcelableQBChatDialog );
