...
public class QBJoinAllGroupDialogCommand extends CompositeServiceCommand {

    private QBAuthHelper authHelper;
    private QBChatHelper chatHelper;

    public QBJoinAllGroupDialogCommand(Context context, QBAuthHelper authHelper, QBChatHelper chatHelper,
